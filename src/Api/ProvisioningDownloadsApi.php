...
class ProvisioningDownloadsApi
{
    ...
    /**
     * Operation provisioningDownloadsControllerCurrentVersionV2
     *
     ...
     * @throws \Yoast\ProvisionerApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yoast\ProvisionerApiClient\Model\ProductVersionsDto
     */
    public function provisioningDownloadsControllerCurrentVersionV2($productCode)
    {
        list($response) = $this->provisioningDownloadsControllerCurrentVersionV2WithHttpInfo($productCode);
        return $response;
    }

    /**
     * Operation provisioningDownloadsControllerCurrentVersionV2WithHttpInfo
     *
     * Get current version of downloads for a product.
     *
     * @param  string $productCode The code used to create the product. (required)
     ...
     * @throws \Yoast\ProvisionerApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yoast\ProvisionerApiClient\Model\ProductVersionsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function provisioningDownloadsControllerCurrentVersionV2WithHttpInfo($productCode)
    {
        $returnType = '\Yoast\ProvisionerApiClient\Model\ProductVersionsDto';
        $request = $this->provisioningDownloadsControllerCurrentVersionV2Request($productCode);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yoast\ProvisionerApiClient\Model\ProductVersionsDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation provisioningDownloadsControllerCurrentVersionV2Async
     *
     * Get current version of downloads for a product.
     *
     * @param  string $productCode The code used to create the product. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function provisioningDownloadsControllerCurrentVersionV2Async($productCode)
    {
        return $this->provisioningDownloadsControllerCurrentVersionV2AsyncWithHttpInfo($productCode)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation provisioningDownloadsControllerCurrentVersionV2AsyncWithHttpInfo
     *
     * Get current version of downloads for a product.
     *
     * @param  string $productCode The code used to create the product. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function provisioningDownloadsControllerCurrentVersionV2AsyncWithHttpInfo($productCode)
    {
        $returnType = '\Yoast\ProvisionerApiClient\Model\ProductVersionsDto';
        $request = $this->provisioningDownloadsControllerCurrentVersionV2Request($productCode);
    ...
    /**
     * Create request for operation 'provisioningDownloadsControllerCurrentVersionV2'
     *
     * @param  string $productCode The code used to create the product. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function provisioningDownloadsControllerCurrentVersionV2Request($productCode)
    {
        // verify the required parameter 'productCode' is set
        if ($productCode === null || (is_array($productCode) && count($productCode) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $productCode when calling provisioningDownloadsControllerCurrentVersionV2'
            );
        }
